...
class BaseFeatureMappingWorkflow(object):
    """ Base Workflow which maps features
        Edit: Adding max_props, max_actns corresponding to max number of propositions and max
        number of actions. These values are useful when building problem-dependent models.

#ifndef GOOSE_LINEAR_REGRESSION_TWO_WL_H
#define GOOSE_LINEAR_REGRESSION_TWO_WL_H
...
class GooseLinearRegressionTwoWl : public Heuristic {
 ...
 public:
  explicit GooseLinearRegressionTwoWl(const plugins::Options &opts);

#ifndef GOOSE_KERNEL_TWO_WL_H
#define GOOSE_KERNEL_TWO_WL_H
...
class GooseKernelTwoWl : public Heuristic {
 ...
 public:
  explicit GooseKernelTwoWl(const plugins::Options &opts);
